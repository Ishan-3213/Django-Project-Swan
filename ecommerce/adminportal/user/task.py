...
def checkout(user_id):
    ...
    html_message = render_to_string(template_name, {"data":data, "subtotal": subtotal, "tax" : tax, "total" : total})
    ...
    send_mail(subject, plain_message, from_mail, to_mail , html_message)
